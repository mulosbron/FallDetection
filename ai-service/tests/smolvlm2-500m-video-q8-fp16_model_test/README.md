# GGUF VLM Batch Image Test — **SmolVLM2-500M-Video-Instruct Q8 + mmproj FP16** (`smolvlm2-500m-video-q8-fp16_model_test`)
...
```bash
python tests/smolvlm2-500m-video-q8-fp16_model_test/test_image.py \
