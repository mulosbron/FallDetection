...
image_folder = r"C:\Users\duggy\OneDrive\Masaüstü\falling"
...
for f in files:
    if f.startswith("fallingtest_1_") and f.endswith((".jpg", ".jpeg", ".png")):
        try:
...
for filename in files:
    ...
    if not filename.startswith("fallingtest_1_"):
        name, ext = os.path.splitext(filename)
        new_name = f"fallingtest_1_{counter:04d}{ext}"
